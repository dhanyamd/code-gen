...
export const CapsuleSchema = z.object({
    commentary : z.string()
    .describe(`Describe what you're about to do and the steps you want to take for generating the code capsule in great detail.`),
    template : z.string()
...
dditional_dependencies: z.array(z.string())
                .describe(
